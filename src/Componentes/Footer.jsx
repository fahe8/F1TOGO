    ...
    <footer className="container mx-auto py-4">
      <div className=" flex justify-between lg:items-center border-b-2 pb-4 px-2">
        ...
        <div className="flex flex-col items-end lg:flex-row justify-center gap-2 w-[20%]">
          ...
          <a href="https://www.instagram.com/f1togo.app?igsh=MW84dHY0YWtkbTBqdQ==" target="_blank" rel="noopener noreferrer">
            <img src={instagram} alt="Instagram" width={25} />
          </a>
          <a href="https://www.tiktok.com/@f1togo4?_t=ZS-8yIT2o3HSDI&_r=1" target="_blank" rel="noopener noreferrer">
            <img src={tiktok} alt="Tiktok" width={25} />
          </a>
        </div>
